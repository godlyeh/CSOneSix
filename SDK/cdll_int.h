...
typedef int HISPRITE;	// handle to a graphic
...
{
	// sprite handlers
	HISPRITE						( *pfnSPR_Load )			( const char *szPicName );
	int							( *pfnSPR_Frames )			( HISPRITE hPic );
	int							( *pfnSPR_Height )			( HISPRITE hPic, int frame );
	int							( *pfnSPR_Width )			( HISPRITE hPic, int frame );
	void						( *pfnSPR_Set )				( HISPRITE hPic, int r, int g, int b );
	...
	void						( *pfnSetCrosshair )		( HISPRITE hspr, wrect_t rc, int r, int g, int b );
...
// Added for user input processing
	...
	const struct model_s *		( *GetSpritePointer )		( HISPRITE hSprite );
	...
	const struct model_s* ( *pfnPrecacheSprite )( HISPRITE spr );
